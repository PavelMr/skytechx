...
class CMLibration
{
  public:
   ...
   int dargs (double J, struct plantbl *plan);
   double gplan (double J, struct plantbl *plan);
...
int CMLibration::sscc (int k, double arg, int n)
{
...
int CMLibration::dargs (double J, struct plantbl *plan)
{
  double T2, w;
...
double CMLibration::gplan (double J, struct plantbl *plan)
{
  double su, cu, sv, cv;
  double t, sl;
