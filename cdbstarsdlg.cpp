...
// todo: trideni podle cisel ne podle retezce (ang sep.)!!!!!!!
  ...
  ui(new Ui::CDbStarsDlg)
{
  ...
  m_model->setHeaderData(1, Qt::Horizontal, tr("Mag 1"));
  m_model->setHeaderData(2, Qt::Horizontal, tr("Mag 2"));
  m_model->setHeaderData(3, Qt::Horizontal, tr("Ang. sep."));
  m_model->setHeaderData(4, Qt::Horizontal, tr("P.A."));
  ...
  ui->treeView->header()->resizeSection(5, 150);
