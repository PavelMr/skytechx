...
public:
  ...
  void mean_elements (double JED);
  int sscc (int k, double arg, int n);
  int g2plan (double J, struct plantbl *plan, double *pobj, int flag);
  double g1plan (double J, struct plantbl *plan);
  int gecmoon (double J, struct plantbl *lrtab, struct plantbl *lattab, double *pobj);
  void moon (double mj, double *lam, double *bet, double *rho);
  void moon_fast (double mj, double *lam, double *bet, double *hp, double *msp, double *mdp);
...
double CMoon::mods3600(double x)
{
  double y;
...
void CMoon::mean_elements (double JED)
{
  double x, T, T2;
 ...
 */
int CMoon::sscc (int k, double arg, int n)
{
...
int CMoon::g2plan (double J, struct plantbl *plan, double pobj[], int flag)
{
...
double CMoon::g1plan (double J, struct plantbl *plan)
{
  int i, j, k, m, k1, ip, np, nt;
  /* On some systems such as Silicon Graphics, char is unsigned
     by default.  */
 ...
 * pobj[2]:  r in au
 */
int CMoon::gecmoon (double J, struct plantbl *lrtab, struct plantbl *lattab, double pobj[])
{
  double x;
 ...
 */
void CMoon::moon_fast (double mj, double *lam, double *bet, double *hp, double *msp,double *mdp)
{
  double t, t2;
  double ld;
  double ms;
 ...
 */
void CMoon::moon (double mj, double *lam, double *bet, double *rho)
{
  double msp;
  double mdp;
  double pobj[3], dt;
